        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[500px] relative">
          ...
          <div className="flex flex-col justify-center py-14 md:py-0">
            <div className="text-center md:text-left space-y-6">
              <h1 className="text-5xl lg:text-6xl font-bold leading-relative xl:leading-normal font-playfair">
              ...
              {/* button */}
              <div className="flex justify-center gap-8 md:justify-start items-center !mt-4">
